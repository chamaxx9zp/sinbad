...
export interface SectionsRelatedProducts extends Schema.Component {
  collectionName: 'components_sections_related_products';
  info: {
    displayName: 'relatedProducts';
    description: '';
  };
  attributes: {
    RelatedProducts: Attribute.String;
    title: Attribute.String;
  };
}

export interface SectionsProductHero extends Schema.Component {
  collectionName: 'components_sections_product_heroes';
  info: {
    displayName: 'ProductHero';
  };
  attributes: {
    Title: Attribute.String;
    PaginationSec: Attribute.String;
    picture: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
  };
}
...
export interface SectionsProductFilterList extends Schema.Component {
  collectionName: 'components_sections_product_filter_lists';
  info: {
    displayName: 'ProductFilterList';
  };
  attributes: {
    ProductFilterList: Attribute.String;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'sections.related-products': SectionsRelatedProducts;
      'sections.product-hero': SectionsProductHero;
      'sections.product-gallery': SectionsProductGallery;
      'sections.product-filter-list': SectionsProductFilterList;
